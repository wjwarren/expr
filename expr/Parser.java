...
public class Parser {
    ...
    /*
     * This must be here in order to initialize ExprConstants by the time this
     * class loads.
     */
    static {
    ...
    static private final int[] rators1 = { ExprConstants.ABS,
            ExprConstants.ACOS, ExprConstants.ASIN, ExprConstants.ATAN,
            ExprConstants.CEIL, ExprConstants.COS, ExprConstants.EXP,
            ExprConstants.FLOOR, ExprConstants.LOG, ExprConstants.ROUND,
            ExprConstants.SIN, ExprConstants.SQRT, ExprConstants.TAN };

    /** names of binary operators */
    static private final String[] procs2 = { "atan2", "max", "min" };
    /** list of int codes in same order as @{code procs2} */
    static private final int[] rators2 = { ExprConstants.ATAN2,
            ExprConstants.MAX, ExprConstants.MIN };
    ...
    private Expr parseFactor() throws SyntaxException {
        ...
        case Token.TT_WORD: {
            ...
            if (token.sval.equals("if")) {
                ...
                expect(')');
                return ExprFactory
                        .makeIfThenElse(test, consequent, alternative);
            }
